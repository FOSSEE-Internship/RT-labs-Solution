...
<div class="container">
    ...
    <ul class="nav nav-pills">
        ...
        <li><button type="button" id="book-slot-nav"><a href="slot.html">Book slot</a></button></li>
        <li><button type="button" id="view-slot-nav"><a href="viewslot.html">View/Delete slot</a></button></li>
...
var showTime = "Current slot "+currTime+"  is vacant";
// 
     //let a = new Date();
...
<h4 id="clock-container"></h4>
            ...
            <form action="currSlot" method="POST"> 
                ...
                <input type="text" name="currslots" id="currslots" value="20">
                <input type="text" name="currDate" id="currDate" value="CURRENT">
